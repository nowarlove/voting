...
<body>
  ...
  <div class="container-fluid row ">
    ...
    ?>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <a href="LoginVoteS.php?Party=<?php echo $PartyName;?>" class="btn btn-primary" style="width: 100%;" >Pilih <?php echo $PartyName;?></a>
        </div>
      </div>
    ...
    <?php 
      ...
      echo "<br><br><br><br>";
      echo "<center style='margin-left: 270px;color:red;'><h3>Voting Belum Di Mulai</h3></center>";
    } ?>
  </div>
  <br>
