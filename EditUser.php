...
<?php 
    ...
    $select="select * from pemilih where Email='$edit_email'";
...
?>
        <form action="" method="POST" >
            ...
            <input type="text"  name="Nim" value="<?php echo $Nim; ?>" pattern="[1-9]{1}[0-9]{9}" maxlength="10" required placeholder="Nim"><br>
...
if($ePassword==$eRePassword){
   ...
   $update="update pemilih set FullName='$eFullName',Nim='$eNim',Password='$ePassword' where Email='$edit_email'";
