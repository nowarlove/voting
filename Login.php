...
<body>
    <div class="login">
        ...
        <form action="" method="POST">
            ...
            <button type="submit" name="submit" >Serahkan</button><br>
            <a href="admin.php">Masuk Sebagai Admin</a>
        </center>
        </form> 
    </div>

    <button class="open-button" onclick="back()">Kembali</button>
...
if(isset($_POST['submit'])){
    ...
    //   $dbPassword=$row_user['Password'];
      ...
      if(is_array($row_user)){//$Email==$dbEmail && $Password==$dbPassword
          ...
          echo "<h5 style='color:red;text-align:center;'>Kesalahan Nama ataupun Password, Silakan periksa kembali!</h5>".mysqli_error($conn);
      }
}
?>
