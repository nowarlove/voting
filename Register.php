...
<body>
    <div class="registerform">
        ...
        <form action="" method="POST" >
            ...
            <input type="text"  name="Nim" pattern="[1-9]{1}[0-9]{9}" maxlength="10" required placeholder="Nim"><br>
...
if($Password==$RePassword){
   ...
   $insert="insert into pemilih(FullName,Nim,Email,Password,Status,Voted) values('$FullName','$Nim','$Email','$Password','OFF','NO')";
