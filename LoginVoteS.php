...
<body>
    <center>
        ...
        $select = "select * from pemilih where Email='$user'";
        ...
        ?>
            ...
            <div style="margin-left: 250px;">
                ...
                if (isset($_GET['Party'])) {
                    ...
                    $select = "select * from kandidat where NoUrutPaslon='$PartyVote'";
                    $run = mysqli_query($conn, $select);
                ...
                <form action="" method="POST"><br>
                    ...
                    <input type="hidden" name="Votes" value="<?php echo $eVotes; ?>" required placeholder="Enter Party Number"><br>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $eVotes = $eVotes + 1;
                    $update = "update kandidat set Votes='$eVotes' where NoUrutPaslon='$PartyVote'";
                    ...
                    $conn = mysqli_connect('localhost', 'root', '', 'voting_system');
                    $Rupdate = "update pemilih set Voted='YES' where FullName='$FullName'";
