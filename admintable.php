...
<body>
  ...
  <div class="content" >
    <div style="overflow-x:auto;">
      <h2 style="text-align: center;font-weight: bolder;">Data Table:</h2>
      <hr>
      ...
      if (isset($_GET['del'])) {
        $del_email = $_GET['del'];
        $delete = "delete from pemilih where Email='$del_email'";
    ...
    <!-- ============Nominee TAble=============================== -->
    <div style="overflow-x:auto;">
    <h2 style="text-align: center;font-weight: bolder;">Candidate Data Table :</h2>
    
    <?php
    if (isset($_GET['ndel'])) {
      $ndel_FullName = $_GET['ndel'];
      $ndelete = "delete from kandidat where Paslon='$ndel_FullName'";
      ...
      ?>
        ...
        <tbody>
          <tr style="text-transform: capitalize;">
            <td><?php echo $nPaslon; ?></td>
            <td><?php echo $nNoUrutPaslon; ?></td>
            <td><img src="upload/<?php echo $nImage; ?>" style="width: 100px;height: 100px; border-radius: 50%;"></td>
            <td>
              <a href="EditNominee.php?nedit=<?php echo $nPaslon; ?>" class="btn btn-primary" title="Edit"><i class="fas fa-pen"></i></a>
              <a href="admintable.php?ndel=<?php echo $nPaslon; ?>" class="btn btn-danger" title="Delete"><i class="fas fa-trash-alt"></i></a>
            </td>
          </tr>
        <?php } ?>
        </tbody>
